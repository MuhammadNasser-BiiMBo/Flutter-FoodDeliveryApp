      ...
      return Scaffold(
        body: Stack(
          children: [
            ...
            cartController.getItems.isNotEmpty?Positioned(
              ...
              child: MediaQuery.removePadding(
                            ...
                            onTap: () {
                              ...
                              if (popularIndex >= 0) {
                                ...
                                if(recommendedIndex<0){
                                  Get.snackbar('History Message', 'Product review is not available for history products',
                ...
                :const NoDataPage(text: 'Your cart is empty !', imgPath: 'assets/images/empty_cart.png')
          ],
        ),
        bottomNavigationBar: cartController.getItems.isNotEmpty?Container(
