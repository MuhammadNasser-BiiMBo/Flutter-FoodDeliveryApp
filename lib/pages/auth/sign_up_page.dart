            ...
            Container(
              ...
              child: Center(
                child: CircleAvatar(
                  ...
                  backgroundImage: const AssetImage('assets/images/logo part 1.png'),
                ),
              ),
            ),
            SizedBox(height: Dimensions.height30,),
            // username
            AppTextField(hint: 'User Name', icon: Icons.person, controller: userNameController, iconColor: AppColors.mainColor),
            SizedBox(height: Dimensions.height20,),
            // Email
            AppTextField(hint: 'Email', icon: Icons.email, controller: emailController, iconColor: AppColors.mainColor),
            SizedBox(height: Dimensions.height20,),
            // password
            AppTextField(hint: 'Password', icon: Icons.password, controller: passwordController, iconColor: AppColors.mainColor),
            SizedBox(height: Dimensions.height20,),
            // phone
            AppTextField(hint: 'Phone', icon: Icons.phone, controller: phoneController, iconColor: AppColors.mainColor),
            SizedBox(height: Dimensions.height30,),
            // Sign up button
            GestureDetector(
              onTap: (){
              ...
              child: Container(
                ...
                child: Center(child: BigText(text: 'Sign up',color: Colors.white,size: 30,)),
              ),
            ),
